...
**50+ 篇笔记** · **15 个分类** · 从基础工具链到 AI Agent 的完整学习路径 · 持续更新中 🟢

<br/>

`Python` `机器学习` `深度学习` `计算机视觉` `NLP` `ROS2` `数据处理` `SQL` `爬虫` `Agent` `Vibe Coding` `MATLAB`
...
| | | |
|:---:|:---:|:---:|
| 🔬 机器学习 / 深度学习 / 强化学习 | 🤖 Agent 智能体 & LangChain | ✨ Vibe Coding 辅助开发 |
| 🦾 ROS2 机器人系统建模与控制 | 👁️ 计算机视觉 & 图像处理 | 🧮 决策与优化算法研究 |
...
![Gazebo](https://img.shields.io/badge/Gazebo-3776AB?style=flat&logo=gazebo&logoColor=white)
...
### 🧠 [rag-qa-system](https://github.com/floaritay/rag-qa-system)

> 基于 RAG 的课程智能问答助手

`LangChain` `FastAPI` `FAISS` `通义千问`

![Stars](https://img.shields.io/github/stars/floaritay/rag-qa-system?style=social)

</td>
<td width="50%">

### 🚦 [Traffic-Signs-Detection](https://github.com/floaritay/Traffic-Signs-Detection-YOLOv8)

> 基于 YOLOv8 的交通标志实时检测 · mAP50: **0.971**

`PyTorch` `Ultralytics` `OpenCV`

![Stars](https://img.shields.io/github/stars/floaritay/Traffic-Signs-Detection-YOLOv8?style=social)
...
### 🎮 [buff_web](https://github.com/floaritay/buff_web)

> 网易 BUFF 平台自动化工具集

`Python` `Requests` · 涂鸦 & 饰品自动搜索购买

![Stars](https://img.shields.io/github/stars/floaritay/buff_web?style=social)

</td>
<td width="50%">

### 💬 [session-manager](https://github.com/floaritay/session-manager)

> Claude Code & Codex 对话记录管理

`Python` `Web UI` · 本地对话日志管理工具

![Stars](https://img.shields.io/github/stars/floaritay/session-manager?style=social)
